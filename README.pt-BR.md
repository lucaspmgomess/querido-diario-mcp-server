...
O projeto está atualmente em beta. A superfície MCP é propositalmente pequena e as mudanças são mantidas conservadoras. O histórico de versões está documentado em [CHANGELOG.md](./CHANGELOG.md).
